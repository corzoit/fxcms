...
<div>    
                ...
                if(file_exists($folder_file.$value_media['file']))
                {
                    ...
                    {      
                        ...
                        $img_html .= "<div class='showDivImage'>
                                        <img class='img' src='".FX_System::url($folder_file.$value_media['file'])."'>
    ...
    <div class="callType">
        <input type="hidden" id="idCallType" name="call_type" value="<?=$_GET['type']?>">
        <input type="hidden" id="language" name="language" value="<?=$_GET['type'] == 'page' ?$fx_page_id.'_'.LANG_SYS : ''?>">
    </div>    
</div>