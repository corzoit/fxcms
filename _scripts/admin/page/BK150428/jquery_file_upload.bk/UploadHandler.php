...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'script_url' => $this->get_full_url().'/admin/page/jquery_file_upload/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/file/img/media/',
            'upload_url' => $this->get_full_url().'/file/img/media/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
